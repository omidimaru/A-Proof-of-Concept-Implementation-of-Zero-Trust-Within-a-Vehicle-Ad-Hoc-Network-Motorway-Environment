...
for i in range(10, 101, 10):
	...
	with open("/home/ben/ns-allinone-3.36.1/ns-3.36.1/results/" + resultsFile) as f:
		...
		delay_f = open('/home/ben/ns-allinone-3.36.1/ns-3.36.1/results/plotfiles/' + malNum + 'm' + str(simMulti) + 's/AvgDelayMs-' + malNum + 'm' + str(simMulti) + 's', 'a')
		...
		nodeThrp_f = open('/home/ben/ns-allinone-3.36.1/ns-3.36.1/results/plotfiles/' + malNum + 'm' + str(simMulti) + 's/AvgNodeThroughputMbps-' + malNum + 'm' + str(simMulti) + 's', 'a')
		...
		networkThrp_f = open('/home/ben/ns-allinone-3.36.1/ns-3.36.1/results/plotfiles/' + malNum + 'm' + str(simMulti) + 's/AvgNetworkThroughputMbps-' + malNum + 'm' + str(simMulti) + 's', 'a')
		...
		resuRegTime_f = open('/home/ben/ns-allinone-3.36.1/ns-3.36.1/results/plotfiles/' + malNum + 'm' + str(simMulti) + 's/AvgRsuRegTime-' + malNum + 'm' + str(simMulti) + 's', 'a')
		...
		networkGP_f = open('/home/ben/ns-allinone-3.36.1/ns-3.36.1/results/plotfiles/' + malNum + 'm' + str(simMulti) + 's/AvgNetworkGoodput-' + malNum + 'm' + str(simMulti) + 's', 'a')
		...
		nodeGP_f = open('/home/ben/ns-allinone-3.36.1/ns-3.36.1/results/plotfiles/' + malNum + 'm' + str(simMulti) + 's/AvgNodeGoodput-' + malNum + 'm' + str(simMulti) + 's', 'a')
		...
		splitDelay_f = open('/home/ben/ns-allinone-3.36.1/ns-3.36.1/results/plotfiles/' + malNum + 'm' + str(simMulti) + 's/AvgSplitDelay-' + malNum + 'm' + str(simMulti) + 's', 'a')
		...
		avgTrustLevel_f = open('/home/ben/ns-allinone-3.36.1/ns-3.36.1/results/plotfiles/' + malNum + 'm' + str(simMulti) + 's/AvgTrustLevel-' + malNum + 'm' + str(simMulti) + 's', 'a')
		...
		avgBadVehicle_f = open('/home/ben/ns-allinone-3.36.1/ns-3.36.1/results/plotfiles/' + malNum + 'm' + str(simMulti) + 's/AvgBadVehicles-' + malNum + 'm' + str(simMulti) + 's', 'a')
		...
		avgBadGuyDecision_f = open('/home/ben/ns-allinone-3.36.1/ns-3.36.1/results/plotfiles/' + malNum + 'm' + str(simMulti) + 's/AvgBadGuyDecision-' + malNum + 'm' + str(simMulti) + 's', 'a')
	...
	with open("/home/ben/ns-allinone-3.36.1/ns-3.36.1/results/" + resultsFile + "-waveReceive.txt") as f:
		datafile = f.readlines()
	...
	with open("/home/ben/ns-allinone-3.36.1/ns-3.36.1/results/" + resultsFile + "-waveSent.txt") as f:
		datafile = f.readlines()
		for line in datafile:
			numSent += 1
	f.close()
	...
	pdr_f = open('/home/ben/ns-allinone-3.36.1/ns-3.36.1/results/plotfiles/' + malNum + 'm' + str(simMulti) + 's/AvgNumNodeRecv-' + malNum + 'm' + str(simMulti) + 's', 'a')
	pdr_f.write(str(numNode) + ' ' + str(avgVehiclesReceived) + '\n')
	pdr_f.close()
	print(numSent)
	pdr_f = open('/home/ben/ns-allinone-3.36.1/ns-3.36.1/results/plotfiles/' + malNum + 'm' + str(simMulti) + 's/AvgPacketDeliveryRatio-' + malNum + 'm' + str(simMulti) + 's', 'a')
